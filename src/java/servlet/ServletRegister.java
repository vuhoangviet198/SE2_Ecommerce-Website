...
public class ServletRegister extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Users user = new Users(username, password, email, phone, address);
        ...
        if (username == null || username.trim().equals("") || password == null || password.trim().equals("")) {
            ...
            try {
                ...
                if (checkexisted == false) {
                    errMess = "This username is already existed. Please choose other username!";
                    request.setAttribute("errMess", errMess);
                    request.getRequestDispatcher("register.jsp").forward(request, response);
                } else {
                    adao.signUpAccount(username, password, email, phone, address);
                    
                    adao.getAccount(username, password);
