...
<html>
    ...
    <body>
        <%
            ...
            Category p = (Category)request.getAttribute("categoryp");
        %>
        <% if (us != null){%>
        ...
        <section id="mainContainer">
            <div class="about" >
                <div class="detail"> 
                    ...
                    Category ID <input type="text" name="cid" required><br>
                    Category Name: <input type="text" name="cname" required><br>
                    
                    <div class="det">
                        <p>Image:</p> <input class="file"type="file" name="image" id="myfile" required><br>
                    </div>                    
                    
                    <input type="submit" value="ADD" style="color: red; margin-left: 100px; margin-top: 20px"><br>
                    <%
                            if (request.getAttribute("err") != null) {
                    %>
                        <h5 style="color: red"><%= request.getAttribute("err")%></h5>
                    <%
                            }
                    %>
                </div>
