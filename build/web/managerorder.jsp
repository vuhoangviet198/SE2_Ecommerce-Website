...
<html>
    ...
    <body>
        ...
        <section id="mainContainer">
            <div class="about" >
                <h2>ALL ORDERS</h2>
                <table style="width: 60%;height: 100%;" border="1px solid black" align="center">
                    <tr>
                        <td style="font-size:20px;"><b>Order ID</b></td>
                        
                        <td style="font-size:20px;"><b>Product Name</b></td>
                        <td style="font-size:20px;"><b>Price</b></td>
                        <td style="font-size:20px;"><b>Quantity</b></td>
                        <td style="font-size:20px;"><b>Total Price</b></td>
