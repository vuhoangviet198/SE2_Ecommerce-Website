...
<html>
    ...
    <head>
        ...
        <title>${requestScope.cname}</title>
        <style>
            .container .para1{
                padding-left: auto;
            }
    ...
    <body>
        <%
            ...
            int idc = list.get(0).getCategory().getCatID();
            int id;
        %>
        <% if (us != null){%>
        ...
        <div class="para1">
                ...
                <a href="category?id=<%=idc%>">${requestScope.cname}</a>
        </div>
        <!-- start Body-->
        <section id="mainContainer">
            <div class="about" >
                <h2 style="font-size:45px;font-family:Time New Roman">${requestScope.cname}</h2>
                <div class="products">
                    <% for (Product p : list) {%>
                    <ul>
                        <li>
                            <div class="product">
                                ...
                                <div class="details">
                                    ...
                                    <% if (us != null) {%>
                                     <a href="product?pid=<%=p.getId()%>&price=<%=p.getPrice()%>đ"> View Details </a>
                                    <%} else if (admin != null) {%>
                                     <a href="product?pid=<%=p.getId()%>&price=<%=p.getPrice()%>đ"> View Details </a>
                                    <a href="updateproduct?pid=<%=p.getId()%>" style="text-decoration: none;">Update</a>
                                    <a href="managerproduct?pname=<%=p.getId()%>" style="text-decoration: none;">Delete</a>
                                    <%} else {%>
                                    <a href="product?pid=<%=p.getId()%>&price=<%=p.getPrice()%>đ"> View Details </a>
                                    <%}%>                                   
                                </div>
