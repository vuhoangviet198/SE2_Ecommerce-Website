    ...
    <body>
        ...
        <section id="mainContainer">
            <div class="about" >
                ...
                <button><a href="addcategory.jsp">ADD CATEGORY</a></button>
                <table style="width: 70%;height: 100%;" border="1px solid black" align="center">
                    <tr>
                        <td style="font-size:20px;"><b>Category ID</b></td>
                        <td style="font-size:20px;"><b>Category Name</b></td>
                        <td style="font-size:20px;"><b>Description Image</b></td>
                        <td style="font-size:20px;"><b>Manage</b></td>
                    </tr>
             <%
                CategoryDAO pdb=new CategoryDAO();
                List<Category> arr=pdb.getAllCategories();
                int start=0,end=6;
                if(arr.size()<6){
                    end=arr.size();
                }
                ...
                List<Category> list=pdb.getListByPage(arr, start, end);
                for(Category y:list){
            %>
            <tr>
                <td><%=y.getCatID()%></td>
                ...
                <td><img src="img/<%=y.getDescription()%>"></td>
                <td><a href="updatecategory?cid=<%=y.getCatID()%>">Update</a>
                    <a href="managercategory?cname=<%=y.getCatname()%>">Delete</a></td>                           
            </tr>
            <%
                }
            %>
            ...
            %>
            <li class="pagination">
                <a href="managercategory.jsp?start=<%=a%>&end=<%=b%>"><%=i%></a>
            </li>
            <%
                }
            %> 
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4 hidden-xs sslCertified">
                    ...
                    <a href="contact.jsp">Contact  / Feedback</a></br>
                </div>
